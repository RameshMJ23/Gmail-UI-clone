...
List<MailModel> account2_mail_data = [
  MailModel(
      senderInfo: SenderInfo(
          senderMail: "english-personalized-digest@quora.com",
          senderName: "Quoraaa Digest",
  ...
  MailModel(
      ...
      title: "Work",
      content:  """" Complete the work attached with this week.
      
      - Thank you
      """ ,
      attachedFile: AttachedFile(isAttached: true, fileName: "work", fileType: FileType.pdf),
      starred: true,
      isSeen: false,
      dateTime: DateTime(2021, 12, 5, 10,11),
      isSelected: false
  ...
  MailModel(
      ...
      title: "Information",
      content:  """ We have attached the information we wanted to conve you kindly check it
      
      
      - Thank you
      """ ,
      attachedFile: AttachedFile(isAttached: true, fileName: "Information", fileType: FileType.word),
      starred: false,
      isSeen: true,
      dateTime: DateTime(2021, 12, 5, 10,11),
      isSelected: false
...
HR Partner """ ,
  ...
  MailModel(
      senderInfo: SenderInfo(
          ...
          senderName: "Quora Digest",
          senderProfilePic: null,
          profileColor: Colors.yellowAccent
      ),
